...
#prepare data
beta1.p = c(1,1,1,-1,-1,-1,0,0,0, 1, rep(0,90))
surv.e = Surv.e
surv.c = Surv.c
...
sim_data = sim_data_fun(n=n, p=p, surv.e=surv.e, surv.c=surv.c, beta1.p = beta1.p, beta2.p=beta1.p )
...
t_groups = vector("list", S)
t_groups[[1]] = time.train

c_groups = vector("list", S)
c_groups[[1]] = status.train

survObjNonPooled   = list("t" = t_groups, "c" = c_groups, "X" = X.train,
